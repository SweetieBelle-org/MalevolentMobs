...
public class MMobSettings {
    ...
    public MMobSettings() {
        ...
        final File file = new File(MMobPlugin.getInstance().getDataFolder(), "config.yml");
        if (!file.exists()) {
    ...
    public boolean getBoolean(final String primaryPropertyPath, final String secondaryPropertyPath, final String propertyName) {
    ...
    public int getInteger(final String primaryPropertyPath, final String secondaryPropertyPath, final String propertyName) {
        return getInteger(primaryPropertyPath, secondaryPropertyPath, propertyName, 0);
    }

    public int getInteger(final String primaryPropertyPath, final String secondaryPropertyPath, final String propertyName, final int defaultValue) {
        if (hasProperty(primaryPropertyPath + "." + propertyName))
    ...
    public float getFloat(final String primaryPropertyPath, final String secondaryPropertyPath, final String propertyName) {
        if (hasProperty(primaryPropertyPath + "." + propertyName))
    ...
    public String getString(final String primaryPropertyPath, final String secondaryPropertyPath, final String propertyName) {
        if (hasProperty(primaryPropertyPath + "." + propertyName))
    ...
    public List<String> getStringList(final String primaryPropertyPath, final String secondaryPropertyPath, final String propertyName) {
        if (hasProperty(primaryPropertyPath + "." + propertyName))
    ...
    public float getScaledValue(final String primarySection, final String secondarySection, final String propertyName, final float scale, final float defaultValue) {
