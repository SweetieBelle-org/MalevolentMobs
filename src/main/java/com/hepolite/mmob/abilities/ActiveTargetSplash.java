...
public abstract class ActiveTargetSplash extends Active {
    ...
    /** Initialization */
    protected ActiveTargetSplash(final MalevolentMob mob, final String name, final Priority priority, final float scale) {
    ...
    public void onTick() {
        ...
        if (++delayTimer > delay) {
            ...
            final List<LivingEntity> entities = Common.getEntitiesInRange(target.getLocation(), range);
