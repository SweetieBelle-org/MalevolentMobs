...
public abstract class PassiveAura extends Passive {
    ...
    /** Initialization */
    protected PassiveAura(final MalevolentMob mob, final String name, final float scale) {
    ...
    public void onTick() {
        ...
        if (++tickTimer >= updateTime) {
            ...
            final List<LivingEntity> entities = Common.getEntitiesInRange(mob.getEntity().getLocation(), range);
