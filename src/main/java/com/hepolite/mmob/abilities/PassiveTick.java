...
public abstract class PassiveTick extends Passive {
    ...
    /** Initialization */
    protected PassiveTick(final MalevolentMob mob, final String name, final Priority priority, final float scale) {
    ...
    public void loadFromConfig(final Settings settings, final Settings alternative) {
        repeats = settings.getInteger(alternative, "repeats", -1);
