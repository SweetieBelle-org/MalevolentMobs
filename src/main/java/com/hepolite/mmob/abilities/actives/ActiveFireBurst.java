...
public class ActiveFireBurst extends ActiveTargetSplash {
    ...
    public ActiveFireBurst(final MalevolentMob mob, final float scale) {
    ...
    @Override
    protected void setTargetEntity(final LivingEntity target) {
    ...
    @Override
    protected void displayArea(final LivingEntity target, final float range) {
    ...
    @Override
    protected void displayAttack(final LivingEntity target, final float range) {
