...
public class ActiveMagicMirror extends ActiveTick {
    ...
    public ActiveMagicMirror(final MalevolentMob mob, final float scale) {
    ...
    public void onTick() {
        ...
        for (int i = 0; i < nodes; i++) {
            ...
            final double angle = nodePosition + (double) i / (double) nodes * 2.0 * Math.PI;

            final Location location = mob.getEntity().getEyeLocation();
