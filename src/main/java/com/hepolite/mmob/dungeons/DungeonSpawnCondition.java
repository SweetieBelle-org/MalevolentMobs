...
public class DungeonSpawnCondition {
    ...
    public boolean isLevelRequirementMet(final float minLevel, final float maxLevel, final float averageLevel) {
    ...
    public boolean isDistanceRequirementMet(final float minDistance, final float maxDistance, final float averageDistance) {
