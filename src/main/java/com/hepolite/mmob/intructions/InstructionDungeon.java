...
public class InstructionDungeon extends Instruction {
    ...
    /** Sets the dungeon the given command sender has selected */
    public static void setSelectedDungeonSpawner(final CommandSender sender, final String spawner) {
        if (spawner == null)
    ...
    public static boolean validateSelectedDungeon(final CommandSender sender) {
        final String dungeon = getSelectedDungeon(sender);
    ...
    public static boolean validateSelectedDungeonSpawner(final CommandSender sender) {
        final Dungeon dungeon = DungeonHandler.getDungeon(getSelectedDungeon(sender));
        if (dungeon == null)
            return false;
