...
public class InstructionSpawn extends Instruction {
    ...
    protected boolean onInvoke(final CommandSender sender, final List<String> arguments) {
        // Get the basic data
        final String role = arguments.get(1);
        Location location = null;
        final Location senderLocation = getSenderLocation(sender);
        ...
        final Entity entity = Common.spawnEntity(location, arguments.get(0));
        ...
        if (entity == null || !(entity instanceof LivingEntity)) {
            ...
            final MalevolentMob mob = MobHandler.getMalevolentMob((LivingEntity) entity);
            if (mob == null)
