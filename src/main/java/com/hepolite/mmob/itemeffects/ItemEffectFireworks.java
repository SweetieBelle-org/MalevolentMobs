...
public class ItemEffectFireworks extends ItemEffectWand {
    ...
    public void onLeftClick(final PlayerInteractEvent event, final Player player, final ItemStack item) {
        ...
        final ProjectileFirework projectile = new ProjectileFirework(player, true, firework, largeDamage, radiusLargeRocket, false);
    ...
    public void onRightClick(final PlayerInteractEvent event, final Player player, final ItemStack item) {
        ...
        final ProjectileFirework projectile = new ProjectileFirework(player, true, firework, smallDamage, radiusSmallRocket, false);
        ProjectileHandler.addProjectile(projectile);
    }
