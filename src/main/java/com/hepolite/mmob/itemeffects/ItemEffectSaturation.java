...
public class ItemEffectSaturation extends ItemEffect {
    ...
    public void onTick(final Player player, final ItemStack item) {
        if (MMobCompatibility.hasPangaea()) {
            ...
            final float oldHunger = player.getFoodLevel();
            final float oldSaturation = player.getSaturation();
            ...
            damageItem(item, durabilityCostPerPoint * (player.getFoodLevel() - oldHunger + (player.getSaturation() - oldSaturation)));
        }
    }
