...
public class ProjectileGrenade extends Projectile {
    ...
    public ProjectileGrenade(final LivingEntity caster, final LivingEntity target, final float speed, final float strength, final int duration, final float range, final boolean affectPlayersOnly) {
        this.caster = caster;
