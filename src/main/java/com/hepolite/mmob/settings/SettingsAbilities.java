...
public class SettingsAbilities {
    ...
    public static void initialize() {
        ...
        final File directory = new File(MMobPlugin.getInstance().getDataFolder() + "/Abilities");
        if (!directory.exists())
            directory.mkdir();
        addDefaultAbilities();
        ...
        for (final File file : files) {
            ...
            else if (parts[0].equalsIgnoreCase("Passive"))
    ...
    public static Settings getPassiveConfig(String ability) {
        ability += ".yml";
        final Settings setting = passives.get(ability);
        if (setting == null) {
    ...
    public static Settings getActiveConfig(String ability) {
        ability += ".yml";
        final Settings setting = actives.get(ability);
        if (setting == null) {
    ...
    private static void addBlazingPillar() {
        final Settings ability = new Settings("Abilities", "Active Blazing_Pillar.yml");
    ...
    private static void addBlindfold() {
        final Settings ability = new Settings("Abilities", "Active Blindfold.yml");
        ability.addDefault("enable", true);
    ...
    private static void addDecoy() {
        final Settings ability = new Settings("Abilities", "Active Decoy.yml");
        ability.addDefault("enable", true);
    ...
    private static void addFireball() {
        final Settings ability = new Settings("Abilities", "Active Fireball.yml");
        ability.addDefault("enable", true);
    ...
    private static void addFireBurst() {
        final Settings ability = new Settings("Abilities", "Active Fire_Burst.yml");
        ability.addDefault("enable", true);
    ...
    private static void addFracturingBlast() {
        final Settings ability = new Settings("Abilities", "Active Fracturing_Blast.yml");
        ability.addDefault("enable", true);
    ...
    private static void addGrenade() {
        final Settings ability = new Settings("Abilities", "Active Grenade.yml");
        ability.addDefault("enable", true);
    ...
    private static void addGroundSlam() {
        final Settings ability = new Settings("Abilities", "Active Ground_Slam.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseCooldown", 20.0);
    ...
    private static void addKidnap() {
        final Settings ability = new Settings("Abilities", "Active Kidnap.yml");
        ability.addDefault("enable", true);
    ...
    private static void addLeashOn() {
        final Settings ability = new Settings("Abilities", "Active Leash_On.yml");
        ability.addDefault("enable", true);
    ...
    private static void addLifesteal() {
        final Settings ability = new Settings("Abilities", "Active Lifesteal.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseCooldown", 16.0);
    ...
    private static void addLightningStrike() {
        final Settings ability = new Settings("Abilities", "Active Lightning_Strike.yml");
        ability.addDefault("enable", true);
    ...
    private static void addMagicBlast() {
        final Settings ability = new Settings("Abilities", "Active Magic_Blast.yml");
        ability.addDefault("enable", true);
    ...
    private static void addMagicMirror() {
        final Settings ability = new Settings("Abilities", "Active Magic_Mirror.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseCooldown", 70.0);
    ...
    private static void addSummonMinion() {
        final Settings ability = new Settings("Abilities", "Active Summon_Minion.yml");
        ability.addDefault("enable", true);
    ...
    private static void addTeleport() {
        final Settings ability = new Settings("Abilities", "Active Teleport.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseCooldown", 35.0);
    ...
    private static void addToxicSpit() {
        final Settings ability = new Settings("Abilities", "Active Toxic_Spit.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseCooldown", 35.0);
    ...
    private static void addVirulentGrasp() {
        final Settings ability = new Settings("Abilities", "Active Virulent_Grasp.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseCooldown", 35.0);
        ability.addDefault("baseDuration", 60);
        ability.save();
    ...
    private static void addVolley() {
        final Settings ability = new Settings("Abilities", "Active Volley.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseCooldown", 25.0);
    ...
    private static void addWeaken() {
        final Settings ability = new Settings("Abilities", "Active Weaken.yml");
        ability.addDefault("enable", true);
    ...
    private static void addWebbing() {
        final Settings ability = new Settings("Abilities", "Active Webbing.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseCooldown", 25.0);
        ability.addDefault("baseCount", 3.0);
        ability.addDefault("baseRange", 4.0);
    ...
    private static void addWitheringBolt() {
        final Settings ability = new Settings("Abilities", "Active Withering_Bolt.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseCooldown", 22.0);
    ...
    private static void addDeterioratingAura() {
        final Settings ability = new Settings("Abilities", "Passive Deteriorating_Aura.yml");
        ability.addDefault("enable", true);
    ...
    private static void addExoskeleton() {
        final Settings ability = new Settings("Abilities", "Passive Exoskeleton.yml");
        ability.addDefault("enable", true);
    ...
    private static void addExplosion() {
        final Settings ability = new Settings("Abilities", "Passive Explosion.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseStrength", 6.0);
    ...
    private static void addFireAura() {
        final Settings ability = new Settings("Abilities", "Passive Fire_Aura.yml");
        ability.addDefault("enable", true);
    ...
    private static void addFreezingAura() {
        final Settings ability = new Settings("Abilities", "Passive Freezing_Aura.yml");
        ability.addDefault("enable", true);
    ...
    private static void addGuardianAngel() {
        final Settings ability = new Settings("Abilities", "Passive Guardian_Angel.yml");
        ability.addDefault("enable", true);
    ...
    private static void addHealer() {
        final Settings ability = new Settings("Abilities", "Passive Healer.yml");
        ability.addDefault("enable", true);
    ...
    private static void addMother() {
        final Settings ability = new Settings("Abilities", "Passive Mother.yml");
        ability.addDefault("enable", true);
    ...
    private static void addMount() {
        final Settings ability = new Settings("Abilities", "Passive Mount.yml");
        ability.addDefault("enable", true);
    ...
    private static void addPoisonMist() {
        final Settings ability = new Settings("Abilities", "Passive Poison_Mist.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseRange", 5.0);
        ability.addDefault("baseStrength", 1.0);
        ability.addDefault("affectPlayersOnly", true);
    ...
    private static void addPotionEffect() {
        final Settings ability = new Settings("Abilities", "Passive Potion_Effect.yml");
        ability.addDefault("enable", true);
        ability.addDefault("repeats", 1);
    ...
    private static void addRegeneration() {
        final Settings ability = new Settings("Abilities", "Passive Regeneration.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseRegeneration", 1.0);
        ability.addDefault("baseStartupDelay", 0);
    ...
    private static void addVampirism() {
        final Settings ability = new Settings("Abilities", "Passive Vampirism.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseRange", 8.0);
    ...
    private static void addWitherAura() {
        final Settings ability = new Settings("Abilities", "Passive Wither_Aura.yml");
        ability.addDefault("enable", true);
        ability.addDefault("baseRange", 5.0);
        ability.addDefault("baseStrength", 1.0);
        ability.addDefault("affectPlayersOnly", true);
    ...
    private static void addWitherParticles() {
        final Settings ability = new Settings("Abilities", "Passive Wither_Particles.yml");
        ability.addDefault("enable", true);
