...
public class SettingsItemEffects {
    ...
    public static void initialize() {
        ...
        final File directory = new File(MMobPlugin.getInstance().getDataFolder() + "/Item Effects");
        if (!directory.exists())
            directory.mkdir();
    ...
    public static Settings getConfig(final String itemEffect) {
        final Settings setting = effects.get(itemEffect);
        if (setting == null) {
    ...
    private static void addArmorShredder() {
        final Settings itemEffect = new Settings("Item Effects", "Armor_Shredder.yml");
    ...
    private static void addBulwark() {
        final Settings itemEffect = new Settings("Item Effects", "Bulwark.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addCharged() {
        final Settings itemEffect = new Settings("Item Effects", "Charged.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addDuplicator() {
        final Settings itemEffect = new Settings("Item Effects", "Duplicator.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addEarthmover() {
        final Settings itemEffect = new Settings("Item Effects", "Earthmover.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addEntropyLimit() {
        final Settings itemEffect = new Settings("Item Effects", "Entropy_Limit.yml");
        itemEffect.addDefault("enable", true);
        itemEffect.addDefault("durabilityCostPerDamage", 1.0);
    ...
    private static void addExplosiveArrows() {
        final Settings itemEffect = new Settings("Item Effects", "Explosive_Arrows.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addFireward() {
        final Settings itemEffect = new Settings("Item Effects", "Fireward.yml");
        itemEffect.addDefault("enable", true);
        itemEffect.addDefault("durabilityCostPerDamage", 1.0);
    ...
    private static void addFireworks() {
        final Settings itemEffect = new Settings("Item Effects", "Fireworks.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addFragile() {
        final Settings itemEffect = new Settings("Item Effects", "Fragile.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addFrost() {
        final Settings itemEffect = new Settings("Item Effects", "Frost.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addGrowth() {
        final Settings itemEffect = new Settings("Item Effects", "Growth.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addHarvest() {
        final Settings itemEffect = new Settings("Item Effects", "Harvest.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addHeated() {
        final Settings itemEffect = new Settings("Item Effects", "Heated.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addHungry() {
        final Settings itemEffect = new Settings("Item Effects", "Hungry.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addLacerate() {
        final Settings itemEffect = new Settings("Item Effects", "Lacerate.yml");
        itemEffect.addDefault("enable", true);
        itemEffect.addDefault("durabilityCostPerDamage", 0.5);
        itemEffect.addDefault("bowDurabilityCostMultiplier", 0.25);
    ...
    private static void addLevity() {
        final Settings itemEffect = new Settings("Item Effects", "Levity.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addMagicMirror() {
        final Settings itemEffect = new Settings("Item Effects", "Magic_Mirror.yml");
        itemEffect.addDefault("enable", true);
        itemEffect.addDefault("durabilityCostPerDamage", 1.0);
    ...
    private static void addMagicShield() {
        final Settings itemEffect = new Settings("Item Effects", "Magic_Shield.yml");
        itemEffect.addDefault("enable", true);
        itemEffect.addDefault("durabilityCostPerDamage", 1.0);
    ...
    private static void addModifier() {
        final Settings itemEffect = new Settings("Item Effects", "Modifier.yml");
        itemEffect.addDefault("enable", true);
        itemEffect.save();
    }

    private static void addPoison() {
        final Settings itemEffect = new Settings("Item Effects", "Poison.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addPowerline() {
        final Settings itemEffect = new Settings("Item Effects", "Powerline.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addRelic() {
        final Settings itemEffect = new Settings("Item Effects", "Relic.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addRunicShield() {
        final Settings itemEffect = new Settings("Item Effects", "Runic_Shield.yml");
        itemEffect.addDefault("enable", true);
        itemEffect.addDefault("durabilityCostPerDamage", 1.0);
    ...
    private static void addSaturation() {
        final Settings itemEffect = new Settings("Item Effects", "Saturation.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addSharpness() {
        final Settings itemEffect = new Settings("Item Effects", "Sharpness.yml");
        itemEffect.addDefault("enable", true);
        itemEffect.addDefault("durabilityCostPerDamage", 0.5);
    ...
    private static void addShockAbsorber() {
        final Settings itemEffect = new Settings("Item Effects", "Shock_Absorber.yml");
        itemEffect.addDefault("enable", true);
        itemEffect.addDefault("durabilityCostPerDamage", 1.0);
    ...
    private static void addShroud() {
        final Settings itemEffect = new Settings("Item Effects", "Shroud.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addThaumicBolt() {
        final Settings itemEffect = new Settings("Item Effects", "Thaumic_Bolt.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addTimber() {
        final Settings itemEffect = new Settings("Item Effects", "Timber.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addTreasure() {
        final Settings itemEffect = new Settings("Item Effects", "Treasure.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addTunneler() {
        final Settings itemEffect = new Settings("Item Effects", "Tunneler.yml");
        itemEffect.addDefault("enable", true);
    ...
    private static void addWither() {
        final Settings itemEffect = new Settings("Item Effects", "Wither.yml");
        itemEffect.addDefault("enable", true);
