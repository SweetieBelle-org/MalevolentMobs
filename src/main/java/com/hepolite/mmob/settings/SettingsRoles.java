...
public class SettingsRoles {
    ...
    public static void initialize() {
        ...
        final File directory = new File(MMobPlugin.getInstance().getDataFolder() + "/Roles");
        if (!directory.exists())
            directory.mkdir();
        addDefaultRoles();
    ...
    public static Settings getConfig(final String role) {
        final Settings setting = roles.get(role);
        if (setting == null) {
    ...
    private static void addCommon() {
        final Settings role = new Settings("Roles", "Common.yml");
    ...
    private static void addTank() {
        final Settings role = new Settings("Roles", "Tank.yml");
    ...
    private static void addBruiser() {
        final Settings role = new Settings("Roles", "Bruiser.yml");
    ...
    private static void addMage() {
        final Settings role = new Settings("Roles", "Mage.yml");
    ...
    private static void addNecromancer() {
        final Settings role = new Settings("Roles", "Necromancer.yml");
    ...
    private static void addArcher() {
        final Settings role = new Settings("Roles", "Archer.yml");
    ...
    private static void addKnight() {
        final Settings role = new Settings("Roles", "Knight.yml");
    ...
    private static void addMatriarch() {
        final Settings role = new Settings("Roles", "Matriarch.yml");
    ...
    private static void addFunnelWeb() {
        final Settings role = new Settings("Roles", "Funnel-Web.yml");
    ...
    private static void addPyre() {
        final Settings role = new Settings("Roles", "Pyre.yml");
    ...
    private static void addPyreJockey() {
        final Settings role = new Settings("Roles", "Pyre_Jockey.yml");
    ...
    private static void addPhantom() {
        final Settings role = new Settings("Roles", "Phantom.yml");
    ...
    private static void addVoidling() {
        final Settings role = new Settings("Roles", "Voidling.yml");
    ...
    private static void addSpellweaver() {
        final Settings role = new Settings("Roles", "Spellweaver.yml");
    ...
    private static void addMal() {
        final Settings role = new Settings("Roles", "Mal.yml");
